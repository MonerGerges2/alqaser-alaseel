          ...
          <section className="relative h-[50vh] overflow-hidden">
               ...
               <div className="relative container mx-auto flex flex-col justify-center px-4 mt-10 h-full z-10">
                    ...
                    <nav className="text-sm mb-4">
                         <Link href="/" className="text-black hover:underline">الرئيسية</Link>
                    ...
                    <div className="text-center">
                         <h1 className="text-5xl font-extrabold mb-4">اتصل بنا</h1>
                         <p className="text-xl mb-6">
                              إذا كان لديك أي استفسار أو تحتاج إلى دعم، لا تتردد في التواصل معنا. نحن هنا لخدمتك وتقديم المساعدة في أي وقت.
                         </p>
                    </div>
               </div>
          </section>
